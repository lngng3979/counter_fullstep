...
# Timing Constraints
###############################################################################
create_clock -name clk -period 3.7000 [get_ports {clk}]
set_clock_transition 0.1500 [get_clocks {clk}]
set_clock_uncertainty 0.2500 clk
set_input_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {data[0]}]
set_input_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {data[1]}]
set_input_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {data[2]}]
set_input_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {data[3]}]
set_input_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {data[4]}]
set_input_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {data[5]}]
set_input_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {data[6]}]
set_input_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {data[7]}]
set_input_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {enable}]
set_input_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {preload}]
set_input_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {resetn}]
set_input_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {up_down}]
set_output_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {count[0]}]
set_output_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {count[1]}]
set_output_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {count[2]}]
set_output_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {count[3]}]
set_output_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {count[4]}]
set_output_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {count[5]}]
set_output_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {count[6]}]
set_output_delay 0.7400 -clock [get_clocks {clk}] -add_delay [get_ports {count[7]}]
###############################################################################
# Environment
###############################################################################
