...
set_input_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {data[0]}]
set_input_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {data[1]}]
set_input_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {data[2]}]
set_input_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {data[3]}]
set_input_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {data[4]}]
set_input_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {data[5]}]
set_input_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {data[6]}]
set_input_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {data[7]}]
set_input_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {enable}]
set_input_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {preload}]
set_input_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {resetn}]
set_input_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {up_down}]
set_output_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {count[0]}]
set_output_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {count[1]}]
set_output_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {count[2]}]
set_output_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {count[3]}]
set_output_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {count[4]}]
set_output_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {count[5]}]
set_output_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {count[6]}]
set_output_delay 0.6000 -clock [get_clocks {clk}] -add_delay [get_ports {count[7]}]
###############################################################################
# Environment
###############################################################################
